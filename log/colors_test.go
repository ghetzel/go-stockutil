...
func cfprintfBuf(messages ...any) string {
	var buf bytes.Buffer
	CFprint(&buf, messages...)
	return buf.String()
}
...
func TestCSprintf(t *testing.T) {
	...
	assert.Equal("this \x1b[0;30mblack\x1b[0m word\n", CSprintln("this ${black}black${reset} word"))
	assert.Equal("this \x1b[0;31mred\x1b[0m word\n", CSprintln("this ${red}red${reset} word"))
	assert.Equal("this \x1b[0;32mgreen\x1b[0m word\n", CSprintln("this ${green}green${reset} word"))
	assert.Equal("this \x1b[0;33myellow\x1b[0m word\n", CSprintln("this ${yellow}yellow${reset} word"))
	assert.Equal("this \x1b[0;34mblue\x1b[0m word\n", CSprintln("this ${blue}blue${reset} word"))
	assert.Equal("this \x1b[0;35mmagenta\x1b[0m word\n", CSprintln("this ${magenta}magenta${reset} word"))
	assert.Equal("this \x1b[0;36mcyan\x1b[0m word\n", CSprintln("this ${cyan}cyan${reset} word"))
	assert.Equal("this \x1b[0;37mwhite\x1b[0m word\n", CSprintln("this ${white}white${reset} word"))
	...
	assert.Equal("this \x1b[0;30mblack\x1b[0m word", cfprintfBuf("this ${black}black${reset} word"))
	assert.Equal("this \x1b[0;31mred\x1b[0m word", cfprintfBuf("this ${red}red${reset} word"))
	assert.Equal("this \x1b[0;32mgreen\x1b[0m word", cfprintfBuf("this ${green}green${reset} word"))
	assert.Equal("this \x1b[0;33myellow\x1b[0m word", cfprintfBuf("this ${yellow}yellow${reset} word"))
	assert.Equal("this \x1b[0;34mblue\x1b[0m word", cfprintfBuf("this ${blue}blue${reset} word"))
	assert.Equal("this \x1b[0;35mmagenta\x1b[0m word", cfprintfBuf("this ${magenta}magenta${reset} word"))
	assert.Equal("this \x1b[0;36mcyan\x1b[0m word", cfprintfBuf("this ${cyan}cyan${reset} word"))
	assert.Equal("this \x1b[0;37mwhite\x1b[0m word", cfprintfBuf("this ${white}white${reset} word"))
